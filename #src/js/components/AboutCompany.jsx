				...
				<div className='about__body'>
					...
					<div className="team-mates about__team-items">
						<ul className="team-mates__list">
							<li>
								<div className="team-mates__image">
									<img src={getPath("@@webRoot/img/footer/team-1.png")} alt="image" />
								</div>
							</li>
							<li>
						...
						<ul className="team-mates__list">
							<li>
								<div className="team-mates__image">
									<img src={getPath("./img/footer/team-2.png")} alt="image" />
								</div>
							</li>
							<li>
								<div className="team-mates__name">
						...
						<ul className="team-mates__list">
							<li>
								<div className="team-mates__image">
									<img src={getPath("@@webRoot/img/footer/team-3.png")} alt="image" />
								</div>
							</li>
							<li>
								<div className="team-mates__name">
						...
						<ul className="team-mates__list">
							<li>
								<div className="team-mates__image">
									<img src={getPath("@@webRoot/img/footer/team-4.png")} alt="image" />
								</div>
							</li>
							<li>
								<div className="team-mates__name">
