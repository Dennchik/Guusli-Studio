...
const Services = () => {
	...
	useEffect(() => {
		...
		if (isMobile.any()) {
			initSwiper.classNameList.add('_swiper');
			swiperLayout();
			servicesSlide();
			if (initSwiper.classNameList.contains('_swiper')) {
			} else {
		...
		<Element className="services key-object"
			...
			<div className="services__body _container">
							...
							<div className="content-box__column line">
								<div className="content-box__image el">
									...
									<a href="#">
										...
										<picture>
											{isWebpSupported()
												? <img className='content-box__bg-img'
				...
				<div className="services__offer offer-container">
					<div className="offer-container__title">Специальное предложение
					</div>
