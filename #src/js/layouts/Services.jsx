...
export default function Services() {
	...
	// 	if (contentRect.top < window.innerHeight - value && contentRect.bottom > 0) {
	// 		el.classList.add('visible');
	// 	} else {
	// 		el.classList.remove('visible');
	// 	}
	// };
	// window.addEventListener('scroll', handleScrollRect);

	// return () => {
	// 	window.removeEventListener('scroll', handleScrollRect);
	// };
	// ---------------------------------------------------------------------------
	useEffect(() => {
	...
	// ---------------------------------------------------------------------------
	return (
		<section className="services" ref={contentServicesRef}>
