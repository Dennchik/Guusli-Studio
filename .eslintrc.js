module.exports = {
	globals: {
		...
		require: true, // Add this line to disable the 'require' is not  defined warning
		global: true // Добавьте эту строку, чтобы отключить предупреждение 'global' is not defined
	},
	'env': {
		'browser': true,
		'es2021': true,
	...
	'rules': {
		...
		'no-unused-vars': 'off' // Полностью отключить проверку неиспользуемых
		// переменных
	}
};
